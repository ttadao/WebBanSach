...
<head>
    ...
    <link href="{{ asset('public/css/custom.admin.css') }}" type="text/css" rel="stylesheet" />
    ...
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="{{ asset('public/css/css/style.default.css') }}" id="theme-stylesheet">
    <!-- jQuery Circle-->
    <link rel="stylesheet" href="{{ asset('public/css/grasp_mobile_progress_circle-1.0.0.min.css') }}">

    <!-- Favicon-->
    <link rel="shortcut icon" href="{{ asset('public/image/favicon.ico'}}">
</head>
<body>
<div class="container">
        ...
        <div class="side-navbar-wrapper">
            <div class="main-menu">
                <ul id="side-main-menu" class="side-menu list-unstyled">
                    <li class="active"><a href="{{ url('/chude') }}"> <i class="icon-home"></i><span>Home</span></a></li>
