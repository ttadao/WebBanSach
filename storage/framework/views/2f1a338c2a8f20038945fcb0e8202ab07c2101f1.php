					...
					<?php else: ?>
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="navbarQuanLy">
								<a class="dropdown-item" href="<?php echo e(url('/nhaxuatban')); ?>">Quản lý nhà xuất bản</a>
								<a class="dropdown-item" href="<?php echo e(url('/loaisach')); ?>">Quản lý loại sách</a>
								<a class="dropdown-item" href="<?php echo e(url('/sach')); ?>">Danh sách sách</a>
